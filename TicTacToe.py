...
def check_for_winner():
    ...
    for combination in combinations:
        if combination[0] in player1_dict['moves'] and combination[1] in player1_dict['moves'] and combination[2] in \
                player1_dict['moves']:
            winner = player1
            player1_dict['victories'] += 1
        elif combination[0] in player2_dict['moves'] and combination[1] in player2_dict['moves'] and combination[2] in \
                player2_dict['moves']:
            winner = player2
...
while game_on is True:
    ...
    while q2 != 'n' or q2 != 'y':
        q2 = input('Would you like to play again? Y or N: ').lower()
        print(q2)
